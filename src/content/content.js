...
export const config = {
  ...
  rsvpApiUrl: 'https://script.google.com/macros/s/AKfycbzzD6UVoYMR0SHZ8CAyJU22AulEfdEcJJfHUr-kzhZ61HzWmZztjUnTPhb8_MKneFGQ/exec', // TODO(Cris & Pris): pegar URL del Web App
  ...
  hotels: [
    { name: 'Hotel ibis México Perinorte', es: 'Ver información.', en: 'View info.', url: 'https://maps.app.goo.gl/7iKddTbW6pmw93mv7' },
    { name: 'One Cuautitlán', es: 'Ver información.', en: 'View info.', url: 'https://maps.app.goo.gl/THimjVZiPMMTTVaW9' },
    { name: 'Fiesta Inn Cuautitlán', es: 'Ver información.', en: 'View info.', url: 'https://maps.app.goo.gl/VSUJG2fQ1ZZpCRGU7' }
  ],

  story: [
    { photo: '/photos/1.png', es: { title: 'Nos conocimos estudiando programación en linea' }, en: { title: 'We met while studying programming online' } },
    { photo: '/photos/2.jpg', es: { title: 'Dios nos ayudaria con la distancia que nos separaba' }, en: { title: 'God would help us change the distance that separated us' } },
    { photo: '/photos/3.jpg', es: { title: 'Despues de citas en linea, primera cita en persona' }, en: { title: 'After dates on line, first date in person' } },
    { photo: '/photos/4.jpg', es: { title: 'Hemos tenido muchas aventuras juntos' }, en: { title: 'We have had many adventures together' } },
    { photo: '/photos/5.jpg', es: { title: 'En mayo del año pasado nos hicimos novios' }, en: { title: 'In May of last year, we became a couple' } },
    { photo: '/photos/6.jpg', es: { title: 'Este año decidimos dar el paso para un futuro juntos' }, en: { title: 'This year we decided to take the next step for a future together' } },
  ],
}
...
export const content = {
  ...
  en: {
    ...
    rsvp: {
      ...
      returnForTable: 'Come back before the big day to see your assigned table.',
    },
    registry: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'For your comfort in the garden, we suggest using sun protection during the day and bringing a jacket or coat for the evening.',
        },
        {
