...
export default function Countdown() {
  const { t } = useLang()
  const { days, hours, minutes, seconds, passed } = useCountdown(config.weddingDateISO)
  ...
  return (
    <section id="countdown" className="bg-night px-6 py-20 text-center sm:py-28">
      <div className="reveal mx-auto max-w-4xl">
        {passed ? (
          <p className="font-display text-3xl text-gold sm:text-5xl">{t.countdown.passed}</p>
        ) : (
          <>
