  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 sm:gap-3">
        ...
        <a
          href="#rsvp"
          className="inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-full bg-gold px-4 py-2 text-xs font-semibold uppercase tracking-wide text-night shadow-md transition-transform duration-200 ease-out hover:scale-[1.04] focus-visible:scale-[1.04] focus-visible:outline-none sm:px-5 sm:text-sm"
        >
